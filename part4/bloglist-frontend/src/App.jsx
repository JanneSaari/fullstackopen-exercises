...
const App = () => {
  ...
  const blogList = () => (
    <div>
      ...
      {blogs
        ...
        .map(blog =>
          <Blog key={blog.id} blog={blog} currentUsername={user.username} updateBlogFn={updateBlog} deleteBlogFn={deleteBlog} />
        )
      }
    </div>
  )
  ...
  return (
    <div>
      ...
      {user &&
        <Togglable buttonLabel='new blog' cancelLabel='show less' ref={blogFormRef}>
